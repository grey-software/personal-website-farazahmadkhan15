<template>
  ...
  <a        href="https://github.com/farazahmadkhan15"
            target="_blank"
          ...
          >
            ...
            <a
            href="https://gitlab.com/farazahmadkhan15"          
            target="_blank"
            class="flex mr-2 text-primary text-md mr-3"
          >
            <svg
  ...
  <a        
            href = "https://web.facebook.com/farazahmadkhan15"  
            target="_blank"
            class="flex mr-2 text-primary text-md mr-3"
          >
<svg
...
>
  <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" />
            ...
            <a 
            href="mailto:farazahmadkhan15@gmail.com"         
            target="_blank"
            class="flex mr-2 text-primary text-md mr-3"
          >
